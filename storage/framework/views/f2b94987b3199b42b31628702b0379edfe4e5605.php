<div class="row contactrow">
    ...
    <div class="col-sm-12">
        <h3><?php echo e(PageBuilder::block('contact_form_text')); ?></h3>
    </div>

    <div class="col-sm-6">
        <div class="form-group <?php echo e(FormMessage::get_class('name')); ?>">
            <span class="help-block"><?php echo e(FormMessage::get_message('name')); ?></span>
            <input class="form-control" id="name" placeholder="Your name" name="name" type="text" />
        </div>
    </div>

    <div class="col-sm-6">
        <div class="form-group <?php echo e(FormMessage::get_class('email')); ?>">
            <span class="help-block"><?php echo e(FormMessage::get_message('email')); ?></span>
            <input class="form-control" id="email" placeholder="Your email" name="email" type="text" />
        </div>
    </div>

    <div class="col-sm-12">
        <div class="form-group <?php echo e(FormMessage::get_class('message')); ?>">
            <span class="help-block"><?php echo e(FormMessage::get_message('message')); ?></span>
            <textarea rows="3" class="form-control" id="message" placeholder="Your message" name="message" cols="50"></textarea>
        </div>
    </div>

    <?php if($form_data->captcha): ?>
        <div class="col-sm-3">
            <div class="form-group <?php echo e(FormMessage::get_class('captcha_code')); ?>">
                <span class="help-block"><?php echo e(FormMessage::get_message('captcha_code')); ?></span>
...
</div><?php /**PATH C:\laragon\www\proyectoweb22\resources\views/themes/coaster2017/blocks/form/contact_form.blade.php ENDPATH**/ ?>