<div class="col-sm-12">
    ...
    <div class="row">
        <div class="col-sm-3">
        <a href="<?php echo $page->url; ?>" class="btn btn-default">Read More</a>
        </div>
    </div>
</div><?php /**PATH C:\laragon\www\proyectoweb22\resources\views/themes/temaGrupo3/categories/posts/page.blade.php ENDPATH**/ ?>