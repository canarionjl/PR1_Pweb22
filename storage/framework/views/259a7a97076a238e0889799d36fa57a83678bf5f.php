      ...
      <?php if( ! empty($directory->folders)): ?>
        <ul>
          <?php $__currentLoopData = $directory->folders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $folder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php echo \View::make('coaster::partials.themes.filetree', ['directory' => $folder, 'theme' => $theme]); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\proyectoweb22\vendor\coastercms\framework\resources/views/admin/partials/themes/filetree.blade.php ENDPATH**/ ?>