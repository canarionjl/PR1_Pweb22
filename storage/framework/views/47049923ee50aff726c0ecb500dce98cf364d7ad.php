        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <?php echo Form::label('menu_item', 'Pages:', ['class' => 'control-label']); ?>
...
<?php /**PATH C:\laragon\www\proyectoweb22\vendor\coastercms\framework\resources/views/admin/modals/menus/add_item.blade.php ENDPATH**/ ?>