...
<div class="form-group <?php echo e($field_class); ?>">
    ...
    <div class="col-sm-10">
        ...
        <a href="javascript:$('#<?php echo $input_id; ?>').select2('val', ''); $('#<?php echo $input_id; ?>_preview').css('display', 'none');">
            Clear selection</a>
...
<?php /**PATH C:\laragon\www\proyectoweb22\vendor\coastercms\framework\resources/views/admin/blocks/video/main.blade.php ENDPATH**/ ?>