...
<div class="row">
    ...
    <div class="col-sm-6 text-right">
        <?php if($add_page): ?>
            <a href="<?php echo e(route('coaster.admin.pages.add')); ?>" class="btn btn-warning addButton" data-page="0"><i
...
<div class="row textbox">
    ...
    <div class="col-sm-12 col-md-4">
      <?php echo Form::open(); ?>
        ...
        <?php echo Form::hidden('search_entity', CoasterCms\Models\Page::class); ?>

        <?php echo Form::text('q', '', array('placeholder' => 'Search pages...', 'class' => 'form-control search-box')); ?>
...
<?php /**PATH C:\laragon\www\proyectoweb22\vendor\coastercms\framework\resources/views/admin/pages/pages.blade.php ENDPATH**/ ?>