    ...
    <div class="col-lg-8 col-md-6 col-sm-6">
        ...
        <div class="form-inline">
            <div class="form-group">
                <?php echo Form::label('role_select', 'View Role: ', ['class' => 'control-label']); ?> &nbsp;
                <?php echo Form::select('role_select', $roles, null, ['id' => 'role', 'class' => 'form-control long-select']); ?>
...
<?php $__env->startSection('scripts'); ?>
    <script type='text/javascript'>
        ...
        function update_checkboxes(role_id) {
            var user_role = parseInt(<?php echo e(Auth::user()->role->id); ?>);
...
<?php /**PATH C:\laragon\www\proyectoweb22\vendor\coastercms\framework\resources/views/admin/pages/roles.blade.php ENDPATH**/ ?>