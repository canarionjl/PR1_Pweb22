        ...
        <div class="modal-content">
            ...
            <div class="modal-body form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-sm-3">
                        <?php echo Form::label('new_role', 'New Role:', ['class' => 'control-label']); ?>

                    </div>
                    <div class="col-sm-9 new_role_container">
                        <?php echo Form::select('new_role', $roles, null, ['class' => 'form-control']); ?>
...
<?php /**PATH C:\laragon\www\proyectoweb22\vendor\coastercms\framework\resources/views/admin/modals/roles/delete.blade.php ENDPATH**/ ?>