...
<?php if($can_upload): ?>
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <?php echo Form::open(['url' => route('coaster.admin.themes.manage'), 'id' => 'uploadThemeForm', 'enctype' => 'multipart/form-data']); ?>
...
<?php $__env->stopSection(); ?><?php /**PATH C:\laragon\www\proyectoweb22\vendor\coastercms\framework\resources/views/admin/pages/themes/list.blade.php ENDPATH**/ ?>