        ...
        <div class="modal-content">
            ...
            <div class="modal-body form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-sm-3">
                        <?php echo Form::label('sublevels', 'Shown Levels:', ['class' => 'control-label']); ?>
...
<?php /**PATH C:\laragon\www\proyectoweb22\vendor\coastercms\framework\resources/views/admin/modals/menus/sub_level_item.blade.php ENDPATH**/ ?>